                ...
                for (var i = 0; i < 5; i++) {
                    ...
                    $.ajax({
                        ...
                        .then(function (response) {
                            ...
                            // var imgDiv = $("<img>");
                            var embedDiv = '<div class="video-container"><iframe width="300" height="150" src="http://www.youtube.com/embed/' + videoId + '"?rel=0" frameborder="0" allowfullscreen></iframe></div>';
                ...
                for (var i = 0; i < 5; i++) {
                    ...
                    $.ajax({
                        ...
                        .then(function (response) {
                            ...
                            // var imgDiv = $("<img>");
                            // var imgSrc = response.items[0].snippet.thumbnails.medium.url;
                            var embedDiv = '<div class="video-container"><iframe width="300" height="150" src="http://www.youtube.com/embed/videoseries?list=' + playlistId + '"?rel=0" frameborder="0" allowfullscreen></iframe></div>';
                            var buttonCode = '<br><a id="' + buttonId + '" class="waves-effect waves-light btn" data-url="' + videoLink + '" ><i class="fas fa-clipboard" aria-hidden="true"></i> Copy</a>'
